    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#user-set").click(function() {
                $("#frame-id").attr("src", "showUserManager");
            });
            $("#product-set").click(function() {
                $("#frame-id").attr("src", "showProductManager");
            });
            $("#product-type-set").click(function() {
                $("#frame-id").attr("src", "type/findAll");
            });
            $("#manager-set").click(function() {
                $("#frame-id").attr("src", "showStaffManager");
            });
            $("#dept-set").click(function() {
                $("#frame-id").attr("src", "showDeptManager");
            });
        });
        $(function () {
            $("#exit").click(function () {
        ...
        <div class="container-flude flude-cc" id="a">
            <div class="row user-setting">
                ...
                <div class="col-xs-9" id="userPanel">
                    <iframe id="frame-id" src="showProductTypeManager" width="100%" height="100%" frameborder="0" scrolling="no">
                </div>
