...
<head>
    ...
    <script type="text/javascript">
        function addProduct(){
            ...
            $.post("${pageContext.request.contextPath}/product/addProduct",params,
                function (result) {
        ...
        function alterProduct(id,name,price,type,index) {
            ...
            $("#updatePro").click(function () {
                ...
                $.post("${pageContext.request.contextPath}/product/alterSelectByPrimaryKey",params,
                    function (result) {
                        window.location.reload();
                    }
                )
        ...
        function delProduct(id) {
            let param = {id:id};
            $.get("${pageContext.request.contextPath}/product/delProductByPrimaryKey",param,
                function (data) {
                    window.location.reload();
            });
        }
