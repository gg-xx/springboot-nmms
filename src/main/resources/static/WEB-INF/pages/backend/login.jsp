        ...
        <div class="panel-body">
            ...
            <form action="${pageContext.request.contextPath}/staff/login" class="form-horizontal ccc" method="post">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="text" name="loginName" value="admin" placeholder="请输入用户名">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">密&nbsp;&nbsp;&nbsp;&nbsp;码：</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="password" name="password" value="admin" placeholder="请输入密码">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        ...
                        <img class="img-rounded" id="codeImage" src="${pageContext.request.contextPath}/code/show" alt="验证码" style="height: 32px; width: 70px;"/>
                    </div>
                    <%--<div class="col-sm-2">--%>
